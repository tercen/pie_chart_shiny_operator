...
# http://localhost:5402/admin/w/73f2fb84b22bb5542af0c50c9c14b930/ds/0ab4a97f-8852-414b-b5b9-020591e44a86
getCtx <- function(session) {
  ctx <- tercenCtx(stepId = "0ab4a97f-8852-414b-b5b9-020591e44a86",
                   workflowId = "73f2fb84b22bb5542af0c50c9c14b930")
  return(ctx)
}
####
############################################
